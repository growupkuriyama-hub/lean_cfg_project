% arXiv preprint version of the manuscript submitted to IJFCS.
% This file is self-contained and uses only standard TeX Live packages.
\pdfoutput=1
...
% microtype omitted for maximum pdfLaTeX/arXiv compatibility.
\usepackage{xcolor}
\usepackage{xurl}
...
\small Growup Learning Academy, Tokyo, Japan\\
...
\medskip
\noindent\textbf{Keywords:} Dyck language; primitive Dyck word; deterministic context-free
