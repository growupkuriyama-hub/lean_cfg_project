...
\newcommand{\Pset}{\bigl(\tfrac14\cdot
  \mathcal N_{\mathrm{pD}}\bigr)_{\ge 12}}
...
Among positive even integers, $46$ alone requires exactly eight summands,
and the integers
...
\]
This is OEIS sequence \seqnum{A395858} \cite{OEIS-A395858}.
...
choose the unique
$S\in\{5,6,7,8\}$ with $S\equiv n\pmod 4$.  Then
\[
...
Three OEIS sequences are discussed in this paper.  The totally balanced
numbers form \seqnum{A014486} \cite{OEIS-A014486}.  The positive
elements of $\NpD$, the primitive Dyck numbers, form \seqnum{A057547}
\cite{OEIS-A057547}.  The central sequence studied here,
$a(n)=r(2n)$, is \seqnum{A395858} \cite{OEIS-A395858}.
