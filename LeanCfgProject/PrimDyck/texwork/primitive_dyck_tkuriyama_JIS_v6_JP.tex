...
\begin{proof}
ある$a_i\in A$に対して、$m=a_1+\cdots+a_k\in kA$であると仮定する。任意の
$k\leq r\leq2k$ に対して、
\[
 \eta_1+\cdots+\eta_k=r,
 \qquad \eta_i\in\{1,2\}
\]
となる $\eta_1,\ldots,\eta_k$ を選べる。したがって、
\[
...
\[
 m:=\frac{n-\rho}{4}
\]
とおくと、$m$ は整数である。さらに、$n\geq4M+k$ および
$\rho\leq k+3$ より
\[
 m\geq\frac{4M+k-(k+3)}{4}
   =M-\frac34
\]
であるから、$m\geq M$ である。一方、$\rho\geq k\geq3$ より
\[
 m=\frac{n-\rho}{4}
 \leq\frac{n-k}{4}
 <n
