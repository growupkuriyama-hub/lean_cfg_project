...
six primitive Dyck numbers.  In particular, $848$ is the sharp even threshold
...
\end{split}
\]
Adding $H$ to the first three short intervals gives
\[
\begin{aligned}
...
\end{aligned}
\]
Their union contains $[245,304]$.  On the other hand, since consecutive
elements of $H$ differ by at most $9$, if $I=[a,b]$ satisfies
$b-a\geq8$, then $H+I=[213+a,248+b]$.  Applying this to the four
remaining long intervals gives
\[
