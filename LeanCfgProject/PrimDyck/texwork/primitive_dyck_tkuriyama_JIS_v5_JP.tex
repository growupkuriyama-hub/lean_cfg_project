...
\]
とおく。$k=0$ のとき、$\varepsilon_1\cdots\varepsilon_k=\lambda$と解釈され、対応する元は $\val{3}{4}=3$ である。$4$ を掛けることは、末尾に基数4の $0$ を付け加えることに対応する。$\varepsilon_1\cdots\varepsilon_k\in\mathsf{Motz}$であるから、補題\ref{lem:base4}より、
