...
actual one-hole derivation contexts.  A full Lean proof would require a
dedicated one-hole derivation formalism.  The current artifact closes the main
Algorithm 1 / FullKept line and records this context-closure coincidence as a
