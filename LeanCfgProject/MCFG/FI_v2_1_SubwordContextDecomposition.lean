...
section SubwordContextDecomposition
...
@[simp] theorem namedFill_twoSidedNamedContext_singletonTuple
  ...
  simpa [twoSidedNamedContext, namedFill, singletonTuple] using
    (rawNamedFill_twoSided left right (singletonTuple middle))
...
def wholeWordSubwordDecompositions
